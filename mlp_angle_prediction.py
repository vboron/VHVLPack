...
# *************************************************************************
def runMLP(train_df: pd.DataFrame, test_df: pd.DataFrame, model_name: str, graph_dir) -> pd.DataFrame:
    if '/' in graph_dir:
    ...
    build_MLPRegressor(X_train, y_train, model_name)
    print('Running ML...')
...
print(df_test)
print('Processing...')
result_df = runMLP(df_train, df_test, args.modelname, args.testset)
print(result_df)
