...
# *************************************************************************
def correct_pred(prediction, stats_cols, stats_csv):
...
# *************************************************************************
def make_dataset_with_corrections(input_csv, input_cols, stats_cols, stats_csv):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cols4d', help='.dat with columns for reading input data', required=True)
