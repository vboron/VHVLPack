#!/usr/bin/python3
"""
Program:    filter_dup_4dTS
File:       filter_dup_4dTS.py
...
residues is the same for a pdb, it'll average the angle to produce one angle per sequence. The .csv data taken is for
combined 4d and T-Scale encoding.
...
def remove_duplicates():
    ...
    col1 = ['code', 'L38a', 'L38b', 'L38c', 'L38d', 'L38e', 'L38f', 'L38g', 'L38h', 'L38i', 'L40a', 'L40b',
            'L40c', 'L40d', 'L40e', 'L40f', 'L40g', 'L40h', 'L40i', 'L41a', 'L41b', 'L41c', 'L41d', 'L41e',
            'L41f', 'L41g', 'L41h', 'L41i', 'L44a', 'L44b', 'L44c', 'L44d', 'L44e', 'L44f', 'L44g', 'L44h',
            'L44i', 'L46a', 'L46b', 'L46c', 'L46d', 'L46e', 'L46f', 'L46g', 'L46h', 'L46i', 'L87a', 'L87b',
            'L87c', 'L87d', 'L87e', 'L87f', 'L87g', 'L87h', 'L87i', 'H33a', 'H33b', 'H33c', 'H33d', 'H33e',
            'H33f', 'H33g', 'H33h', 'H33i', 'H42a', 'H42b', 'H42c', 'H42d', 'H42e', 'H42f', 'H42g', 'H42h',
            'H42i', 'H45a', 'H45b', 'H45c', 'H45d', 'H45e', 'H45f', 'H45g', 'H45h', 'H45i', 'H60a', 'H60b',
            'H60c', 'H60d', 'H60e', 'H60f', 'H60g', 'H60h', 'H60i', 'H62a', 'H62b', 'H62c', 'H62d', 'H62e',
            'H62f', 'H62g', 'H62h', 'H62i', 'H91a', 'H91b', 'H91c', 'H91d', 'H91e', 'H91f', 'H91g', 'H91h',
            'H91i', 'H105a', 'H105b', 'H105c', 'H105d', 'H105e', 'H105f', 'H105g', 'H105h', 'H105i', 'angle']
    ...
    seq_df = res_file.groupby(['code', 'L38a', 'L38b', 'L38c', 'L38d', 'L38e', 'L38f', 'L38g', 'L38h', 'L38i',
                               ...
                               'H105i']).aggregate(aggregation_func)
...
results.to_csv('no_duplicates_4dTSData.csv', index=False)
